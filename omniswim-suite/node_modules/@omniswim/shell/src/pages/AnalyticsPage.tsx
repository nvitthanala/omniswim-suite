          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey="men" stroke="var(--color-info)" name="Men" strokeWidth={2} />
                <Line type="monotone" dataKey="women" stroke="var(--color-success)" name="Women" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
