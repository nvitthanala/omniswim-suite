...
export default function TeamCard({ team, index, gender, eventsList = [], conference, searchQuery, actualScore, baselineScore, eventThrough, onUpdateTime, onRequestDeleteSwimmer }: Props) {
                      ...
                      {s.isRelay && (s.relayLegSplitDetail || s.relayLegSplit) ? (
                        <>
                          ...
                          {s.relayLegSplitDetail ? (
                            <span className="block text-[7px] text-theme-muted font-sans">
