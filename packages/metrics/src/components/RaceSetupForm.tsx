    ...
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="space-y-4 flex-1 overflow-y-auto pr-2 pb-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-ui-micro font-bold uppercase tracking-widest text-slate-500 flex items-center gap-1.5">
        ...
        <div className="border border-slate-200 dark:border-white/10 rounded-lg p-3 space-y-3 mt-4">
          ...
          <p className="text-ui-micro text-slate-500 leading-tight mb-2">
            Auto-calculated using video event tracking (D, B markers). You can override them below if needed.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-ui-micro font-bold uppercase tracking-widest text-slate-500">
                Init Velocity (m/s)
              </label>
              <input
                type="number"
      ...
      <div className="mt-auto pt-6 border-t border-slate-200 dark:border-white/10 shrink-0">
        ...
        {!isReady && (
           <p className="text-ui-micro text-center text-slate-500 mt-2">
