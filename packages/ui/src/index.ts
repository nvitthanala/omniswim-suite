...
export {
  ...
  describeCaptureScope as describeSwimCloudCaptureScope,
  describeUnplannedPass as describeSwimCloudUnplannedPass,
  capturePassStatus as swimCloudCapturePassStatus,
  ...
  type SwimCloudCapturePassStatus,
