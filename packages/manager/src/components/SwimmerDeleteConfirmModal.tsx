    ...
    >
        ...
        <div className="space-y-3 mb-6">
          <Button
            ...
            size="md"
            onClick={onHide}
            className="block w-full text-left font-normal normal-case tracking-normal p-3.5 hover:bg-[var(--surface-strong)]"
          >
          ...
          <Button
            ...
            size="md"
            onClick={onRemove}
            className="block w-full text-left font-normal normal-case tracking-normal p-3.5 border-rose-400/40 hover:border-rose-400/70 hover:bg-rose-400/10"
          >
