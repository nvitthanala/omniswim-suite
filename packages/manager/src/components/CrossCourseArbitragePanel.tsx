...
function formatMargin(sec: number): string {
 ...
 */
function groupSwaps(swaps: ExactSwap[]): SwapGroup[] {
...
type RelaySwapGroup = { best: RelayLegSwap; otherCandidates: number };
 ...
 */
function groupRelaySwaps(swaps: RelayLegSwap[]): RelaySwapGroup[] {
